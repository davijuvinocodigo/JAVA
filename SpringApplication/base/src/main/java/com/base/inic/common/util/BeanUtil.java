package com.base.inic.common.util;
...
public class BeanUtil {
     ...
     */
    public static <E> List<Map<String, Object>> transBeansToListMap(List<E> sourceList, String properties) throws ClassNotFoundException {
    ...
    public static <E> List<Map<String, Object>> transBeansToListMap(List<E> sourceList, Class<?> clazz) throws ClassNotFoundException {
